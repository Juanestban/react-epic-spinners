...
const animationBoxShadow = (arg = [], color) => {
...
export const FlowerSpinner = styled.div`
  ...
  & .dots-container {
    width: ${dotsWidthAndHeight};
    height: ${dotsWidthAndHeight};
  }
  ...
  & .bigger-dot {
    ...
    border-radius: 50%;
    animation: flower-spinner-smaller-dot-animation ${durations} 0s infinite
      both;
  }

  & .bigger-dot {
    padding: 10%10%;
    animation: flower-spinner-bigger-dot-animation ${durations} 0s infinite both;
  }

  @keyframes flower-spinner-bigger-dot-animation {
    0%,
    100% {
      box-shadow: ${({ color = 'rgb(255,29,94)' }) =>
        animationBoxShadow(
          [
            [0, 0, 0],
            [0, 0, 0],
